/*
 This is a sample sketch to show how to use the GasBtLibrary
 to detect click events on 2 buttons in parallel. 
 The library internals are explained at
 http://www.mathertel.de/Arduino/GasBtLibrary.aspx
...
// Setup a new GasBt on pin A1.  
GasBt button1(A1, true);
// Setup a new GasBt on pin A2.  
GasBt button2(A2, true);
